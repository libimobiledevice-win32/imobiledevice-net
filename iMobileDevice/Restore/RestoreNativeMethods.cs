...
namespace iMobileDevice.Restore
{
    ...
    public partial class RestoreNativeMethods
    {
        ...
        public static extern RestoreError restored_query_type(RestoreClientHandle client, [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(NativeStringMarshaler))] out string type, ref ulong version);

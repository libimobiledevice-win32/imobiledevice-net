...
namespace iMobileDevice.InstallationProxy
{
    ...
    public partial class InstallationProxyNativeMethods
    {
        ...
        public static extern InstallationProxyError instproxy_lookup(InstallationProxyClientHandle client, [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(NativeStringArrayMarshaler))] System.Collections.ObjectModel.ReadOnlyCollection<string> appids, PlistHandle clientOptions, out PlistHandle result);
        ...
        public static extern InstallationProxyError instproxy_check_capabilities_match(InstallationProxyClientHandle client, [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(NativeStringMarshaler))] out string capabilities, PlistHandle clientOptions, out PlistHandle result);
        ...
        public static extern void instproxy_command_get_name(PlistHandle command, [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(NativeStringMarshaler))] out string name);
        ...
        public static extern void instproxy_status_get_name(PlistHandle status, [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(NativeStringMarshaler))] out string name);
        ...
        public static extern InstallationProxyError instproxy_status_get_error(PlistHandle status, [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(NativeStringMarshaler))] out string name, [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(NativeStringMarshaler))] out string description, ref ulong code);
        ...
        public static extern InstallationProxyError instproxy_client_get_path_for_bundle_identifier(InstallationProxyClientHandle client, [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.LPStr)] string bundleId, [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(NativeStringMarshaler))] out string path);
    }
}

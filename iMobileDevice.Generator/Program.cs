...
namespace iMobileDevice.Generator
{
    ...
    internal class Program
    {
        public static void Main(string[] args)
        {
            ...
            generator.IncludeDirectories.Add(Path.Combine(sourceDirectory, @"packages\libimobiledevice.1.2.1.191\build\native\include\"));
            ...
            var iMobileDeviceDirectory = Path.Combine(sourceDirectory, @"packages\libimobiledevice.1.2.1.191\build\native\include\libimobiledevice");
